...
public class HearingsJmsConfig {
    ...
    @Bean
    public ConnectionFactory hmcJmsConnectionFactory(@Value("${spring.application.name}") final String clientId) {
    ...
    @Bean
    public JmsListenerContainerFactory<DefaultMessageListenerContainer> hmcEventTopicContainerFactory(
        ConnectionFactory hmcJmsConnectionFactory,
        DefaultJmsListenerContainerFactoryConfigurer configurer) {
        DefaultJmsListenerContainerFactory factory = new DefaultJmsListenerContainerFactory();
        factory.setConnectionFactory(hmcJmsConnectionFactory);
